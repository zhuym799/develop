--[[
**********************************************************************************
Function:	ir_GetExcelVersion()
Purpose:	Detects the existance of Microsoft Excel / Excel Viewer
Arguments:	None.
Returns:	Version number, 0.0.0.0 if Excel / Excel Viewer does not exist
**********************************************************************************
]]
...
--%%                                                                %%
--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	local tValidFileNames = {"excel", "xlview"};
	local strDefaultExtension = "xls";
